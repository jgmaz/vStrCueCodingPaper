...
%DIF DEL vStrCueCoding_v2.tex   Sat Dec  2 19:35:19 2017
%DIF ADD vStrCueCoding_v1.tex   Fri Sep 22 16:59:29 2017
...
\caption{Schematic of potential coding strategies employed by single units in the NAc. \DIFdelbeginFL \DIFdelFL{H1 (left panel): }\DIFdelendFL Coding of identifying cue features \DIFdelbeginFL \DIFdelFL{is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{could occur either be }\DIFaddendFL absent in the NAc \DIFdelbeginFL \DIFdelFL{. Top row: Unit A responds to a motivationally relevant variable, such as expected value, similarly across other cue features, such as stimulus modality or physical location. Hypothetical plot is firing rate across time. Light+ }\DIFdelendFL (\DIFdelbeginFL \DIFdelFL{red}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{left}\DIFaddendFL )\DIFdelbeginFL \DIFdelFL{signifies a rewarded light cue}\DIFdelendFL , \DIFdelbeginFL \DIFdelFL{Sound+ (blue) a rewarded sound cue. Dashed line indicates onset of cue. Bottom row: No units within the NAc discriminate their firing across various conditions of these cue features. H2 (middle panel): Coding of cue features occurs }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{occur }\DIFaddendFL independently of encoding of motivationally relevant variables like expected value or subsequent vigor \DIFdelbeginFL \DIFdelFL{. Top row: Same as H1. Bottom row: Unit B discriminates firing across conditions of a cue feature, depicted here as firing to Light+ but not Sound+. H3 }\DIFdelendFL (\DIFdelbeginFL \DIFdelFL{right panel}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{middle}\DIFaddendFL )\DIFdelbeginFL \DIFdelFL{: Coding of cue features is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, and/or be }\DIFaddendFL integrated with coding of other motivationally relevant variables \DIFaddbeginFL \DIFaddFL{(right)}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{Hypothetical example demonstrating a unit that responds to reward-predictive cues, but firing rate is also modulated by which rewarded-predictive cue is presented, firing more for Light+ than Sound+.}\DIFdelendFL }
\label{fig:schematic}
...
\caption{Performance on the behavioral task. A-B. Example learning curves \DIFdelbeginFL \DIFdelFL{across sessions }\DIFdelendFL from \DIFdelbeginFL \DIFdelFL{a single subject (}\DIFdelendFL R060 \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL showing \DIFaddbeginFL \DIFaddFL{acquisition and maintenance of performance in }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{proportion approached for rewarded (red line for }\DIFdelendFL light \DIFdelbeginFL \DIFdelFL{block, navy blue line for sound block}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(A}\DIFaddendFL ) and \DIFdelbeginFL \DIFdelFL{unrewarded trials (green line for light block, light blue line for }\DIFdelendFL sound \DIFdelbeginFL \DIFdelFL{block}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(B}\DIFaddendFL ) \DIFaddbeginFL \DIFaddFL{blocks}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{Fully correct performance corresponds to approach }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Dependent measure is }\DIFaddendFL proportion of \DIFaddbeginFL \DIFaddFL{trials approached within a session for a given cue, with a value of }\DIFaddendFL 1 \DIFaddbeginFL \DIFaddFL{being perfect performance }\DIFaddendFL for rewarded \DIFdelbeginFL \DIFdelFL{trials }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{cues, }\DIFaddendFL and 0 \DIFaddbeginFL \DIFaddFL{being perfect performance }\DIFaddendFL for unrewarded \DIFdelbeginFL \DIFdelFL{trials}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{cues}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{Note that this subject starts out approaching on both rewarded and unrewarded trials, and learns with experience to skip non-rewarded trials. }\DIFdelendFL Red bars indicate days in which a rat statistically discriminated between rewarded and unrewarded cues, determined by a chi square test. Dashed line indicates time of \DIFdelbeginFL \DIFdelFL{electrode implant surgery}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{implantation}\DIFaddendFL . C-D. Summary of performance during recording sessions for each rat. C. \DIFdelbeginFL \DIFdelFL{Proportion approached for all rats, averaged across all recording sessions. Different columns indicate the different cues (rewarded (+) and unrewarded (-) light cues, rewarded and unrewarded sound cues). Different symbols correspond to individual subjects; black line shows the mean. }\DIFdelendFL All rats learned to discriminate between \DIFaddbeginFL \DIFaddFL{the }\DIFaddendFL rewarded and unrewarded cues \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{within a block }\DIFaddendFL as \DIFdelbeginFL \DIFdelFL{indicated }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{measured }\DIFaddendFL by \DIFdelbeginFL \DIFdelFL{the clear difference }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a comparison }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{proportion approached between rewarded (0.9x approached) and unrewarded cues (0.3x approached)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{linear mixed effects models}\DIFaddendFL , \DIFaddbeginFL \DIFaddFL{interpreted as a decreased likelihood to make an approach }\DIFaddendFL for \DIFdelbeginFL \DIFdelFL{both blocks (see Results for statistics)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{an unrewarded cue}\DIFaddendFL . D. Average \DIFdelbeginFL \DIFdelFL{trial }\DIFdelendFL length \DIFaddbeginFL \DIFaddFL{of time to complete a trial }\DIFaddendFL for each cue. \DIFdelbeginFL \DIFdelFL{Note that the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Rats on average showed a comparable length of }\DIFaddendFL time to complete a trial \DIFdelbeginFL \DIFdelFL{was comparable for the different cues}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{regardless of cue}\DIFaddendFL .}
\label{fig:behav}
\end{figure}
...
\DIFdelbegin \DIFdel{We sought to address which parameters of our task were encoded by NAc activity, specifically whether the NAc encodes aspects of motivationally relevant cues not directly tied to reward, such as the identity and location of the cue, and whether this coding is independent or integrated with coding of cue outcome. To do this we recorded a }\DIFdelend \DIFaddbegin \DIFadd{A }\DIFaddend total of 443 units \DIFaddbegin \DIFadd{were recorded }\DIFaddend in the NAc from 4 rats over 57 sessions \DIFdelbegin \DIFdel{while they performed on the square track }\DIFdelend (Table \ref{tbl1}). \DIFdelbegin \DIFdel{Units that had less than 200 spikes, or exhibited a drift in firing rate over the course of either block were excluded from further analysis. }\DIFdelend The activity of 133 (30\%) of these was modulated by the cue, with more units showing a decrease in firing (n = 124) than an increase (n = 47) around the time of cue-onset (Table \ref{tbl2}). Within this group, 32 were classified as HFNs, while 139 were classified as SPNs. \DIFdelbegin \DIFdel{To determine whether these cue-evoked responses were modulated by various aspects of the task, we fit }\DIFdelend \DIFaddbegin \DIFadd{Fitting }\DIFaddend a GLM to each \DIFdelbegin \DIFdel{cue-modulated unit . Fitting GLMs }\DIFdelend \DIFaddbegin \DIFadd{unit }\DIFaddend revealed that a variety of task parameters accounted for a significant portion of firing rate variance in NAc cue-modulated units \DIFdelbegin \DIFdel{, with all task parameters except trial history being predictors in 19-38\% of cue-modulated units, and explaining ~4-9\% on average, although there was substantial variability across cells (Figures \ref{fig:examples}, \ref{fig:GLM}, Table \ref{tbl2}}\DIFdelend \DIFaddbegin \DIFadd{(Figures \ref{fig:exmaples}, \ref{fig:GLM}}\DIFaddend ). Notably, there were units that discriminated between whether the rat was performing in the light or sound block\DIFdelbegin \DIFdel{(n = 37 / 133)}\DIFdelend , which arm the rat was currently on\DIFdelbegin \DIFdel{(n = 50 / 133)}\DIFdelend , and whether the rat was engaged in a rewarded or unrewarded trial (\DIFdelbegin \DIFdel{n = 34 / 133), suggesting that the NAc independently encodes features of reward-predictive cues separate from expected outcome (}\DIFdelend Figure \ref{fig:examples}A-F). \DIFdelbegin \DIFdel{Furthermore, interactions }\DIFdelend \DIFaddbegin \DIFadd{Interactions }\DIFaddend between multiple cue features appeared as significant predictors of firing rate variance for 9\% cue-modulated units\DIFdelbegin \DIFdel{(n = 11 / 133)}\DIFdelend , although this effect was \DIFdelbegin \DIFdel{modest (~1-2\% variance explained), suggesting a weak effect for integrated coding across various aspects of a cue (}\DIFdelend \DIFaddbegin \DIFadd{relatively modest (}\DIFaddend Figure \ref{fig:examples}G,H). Fitting a GLM to all recorded units...*Jimmie finish this* (data not shown).
...
\caption{Individual examples of NAc units influenced by various task parameters. A. Example of a NAc unit that showed an increase in firing in response to the cue, and whose activity was influenced by which block the rat was in. Top: rasterplot showing the spiking activity across all trials aligned to cue-onset. Spikes across trials are color coded according to cue type\DIFdelbeginFL \DIFdelFL{(red: rewarded light; green: unrewarded light; navy blue: rewarded sound; light blue: unrewarded sound)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, using the same scheme as in previous figures}\DIFaddendFL . Green and magenta bars indicate trial termination when a rat initiated the next trial or made a nosepoke, respectively. \DIFdelbeginFL \DIFdelFL{White space halfway up the rasterplot indicates switching from one block to the next. Dashed line indicates cue onset. }\DIFdelendFL Bottom: PETHs showing the average smoothed firing rate for the unit for \DIFdelbeginFL \DIFdelFL{trials during }\DIFdelendFL light (red) and sound (blue) blocks, aligned to cue-onset. \DIFdelbeginFL \DIFdelFL{Lightly shaded area indicates standard error of the mean. Note this unit showed a larger increase in firing to sound cues. }\DIFdelendFL B. Same as A \DIFdelbeginFL \DIFdelFL{, but }\DIFdelendFL for a unit that showed a decrease in firing\DIFdelbeginFL \DIFdelFL{to the cue}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{Note the sustained higher firing rate during the light block. }\DIFdelendFL C-D. Same as A-B for cue location, each color in the PETHs represents average firing response for a different cue location. \DIFdelbeginFL \DIFdelFL{C. This firing rate of this unit only changed on arm 3 of the task. D. Firing decreased for this unit on all arms but arm 4. }\DIFdelendFL E-F. Same as A-B for cue outcome, with the PETHs comparing rewarded (red) and unrewarded (green) trials. \DIFdelbeginFL \DIFdelFL{E. This unit showed a slightly higher response during presentation of rewarded cues. F. This unit showed a dip in firing when presented with rewarded cues. }\DIFdelendFL G-H. Example of units who were modulated by both cue modality and location (G) and cue modality and outcome (H) \DIFaddbeginFL \DIFaddFL{using similar color schemes as the other examples}\DIFaddendFL .}
\label{fig:examples}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Fig 6 - GLM.png}
\caption{Summary of influence of various task parameters \DIFdelbeginFL \DIFdelFL{on }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{of }\DIFaddendFL cue-modulated NAc units after cue-onset. A. GLM matrix demonstrating impact of various task parameters on NAc firing rates. A \DIFdelbeginFL \DIFdelFL{stepwise }\DIFdelendFL GLM was fit to each unit that showed evidence of cue modulation by a Wilcoxon signed-rank test. Each row represents a given task parameter, and \DIFdelbeginFL \DIFdelFL{each column is }\DIFdelendFL the \DIFaddbeginFL \DIFaddFL{x axis shows the }\DIFaddendFL influence of \DIFdelbeginFL \DIFdelFL{that }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the }\DIFaddendFL task \DIFdelbeginFL \DIFdelFL{parameter on a given }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{parameters for each }\DIFaddendFL unit\DIFdelbeginFL \DIFdelFL{. Response variable is how much of the firing rate variance an individual predictor contributed to the model}\DIFdelendFL , \DIFdelbeginFL \DIFdelFL{as measured by differences in R-squared between the final model and the model minus the predictor of interest. Ordering }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{organized }\DIFaddendFL from left to right \DIFdelbeginFL \DIFdelFL{: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{for }\DIFaddendFL MSNs that increased firing in response to the cue (green \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL left), MSNs with a decreasing response (red \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL left), FSIs with an increasing response (green \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL right), FSIs with a decreasing response (red \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL right). \DIFdelbeginFL \DIFdelFL{Darker shades indicate more }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Response variable is how much of the }\DIFaddendFL firing rate variance \DIFdelbeginFL \DIFdelFL{explained }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{an individual predictor contributed to the model, as measured }\DIFaddendFL by \DIFdelbeginFL \DIFdelFL{a given }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{differences in R-squared between the final model and the model minus the }\DIFaddendFL predictor \DIFaddbeginFL \DIFaddFL{of interest}\DIFaddendFL . B. \DIFdelbeginFL \DIFdelFL{Violin plots }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Bar graph }\DIFaddendFL demonstrating \DIFdelbeginFL \DIFdelFL{changes }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{average change }\DIFaddendFL in R-squared \DIFdelbeginFL \DIFdelFL{values }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{value }\DIFaddendFL with the addition of each of the individual predictors.\DIFdelbeginFL \DIFdelFL{The mean, median, and distribution of changes in R-squared values is plotted for each of the seven task parameters used in the GLM.}\DIFdelendFL }
\label{fig:GLM}
\end{figure}
{\bf Population level responses:}

\DIFdelbegin \DIFdel{NAc units do not work in isolation, and some information about the cue may be hidden in single unit responses. }\DIFdelend To get a sense of how \DIFdelbegin \DIFdel{NAc output encoded cue information }\DIFdelend \DIFaddbegin \DIFadd{cue information was encoded }\DIFaddend at the population level, \DIFdelbegin \DIFdel{we normalized }\DIFdelend firing activity for each unit \DIFdelbegin \DIFdel{that was }\DIFdelend modulated by a \DIFdelbegin \DIFdel{given cue feature , then generated the }\DIFdelend \DIFaddbegin \DIFadd{cue feature was z-scored, then the population average for a cue feature was aligned to }\DIFaddend cue-onset \DIFdelbegin \DIFdel{aligned population average firing rate for each of the cue features }\DIFdelend \DIFaddbegin \DIFadd{was generated }\DIFaddend (Fig \ref{fig:pop}). This \DIFdelbegin \DIFdel{analyses revealed overall that cells that showed an increase upon cue presentation had stronger responses for the preferred cue condition (Figure \ref{fig:pop}A,C,E). Interestingly, units that were classified as decreasing in response to the cue showed a biphasic response at the population level, with a small peak at a time in alignment with entry into the arm, followed by a sustained dip after cue-onset (Figure \ref{fig:pop}B,D,F). Units that were }\DIFdelend \DIFaddbegin \DIFadd{visualization of the data revealed units whose activity was }\DIFaddend modulated by cue modality showed \DIFdelbegin \DIFdel{by a stronger increase in response to the preferred cue modality, as well as a higher tonic firing rate to the preferred cue modality, most notably in units that decreased in firing rate }\DIFdelend \DIFaddbegin \DIFadd{a difference in firing rate across blocks that extended beyond the transient response }\DIFaddend to the cue (Figure \ref{fig:pop}A,B). \DIFdelbegin \DIFdel{Units that were modulated by cue location showed a graded response to locations of decreasing preference (Figure \ref{fig:pop}C,D). }\DIFdelend Additionally, units whom had exhibited a decrease in firing in response to the cue and whose activity was modulated by cue outcome, showed a sustained \DIFdelbegin \DIFdel{discriminatory response to rewarded and unrewarded cues }\DIFdelend \DIFaddbegin \DIFadd{response }\DIFaddend that extended beyond cue-onset (Figure \ref{fig:pop}F).  
\DIFdelbegin \DIFdel{Together, these visualizations of the averaged population responses revealed nuanced differences in the way NAc units are modulated by cue conditions across cue features.  
}\DIFdelend 
...
\caption{Distribution of NAc firing rates across \DIFdelbeginFL \DIFdelFL{time }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{task space }\DIFaddendFL surrounding \DIFdelbeginFL \DIFdelFL{cue onset}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{cue-onset}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{Each panel shows normalized firing }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A. Firing }\DIFaddendFL rates for all recorded \DIFdelbeginFL \DIFdelFL{NAc }\DIFdelendFL units \DIFdelbeginFL \DIFdelFL{(each row corresponds to one unit) as a function of time (time 0 indicates cue onset), averaged across all trials for a specific cue type, indicated by text labels. A, left: Heat plot showing smoothed }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{were }\DIFaddendFL normalized \DIFdelbeginFL \DIFdelFL{firing activity of all recorded NAc units }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and }\DIFaddendFL ordered according \DIFaddbeginFL \DIFaddFL{according }\DIFaddendFL to \DIFdelbeginFL \DIFdelFL{the time of their }\DIFdelendFL peak firing \DIFdelbeginFL \DIFdelFL{rate during the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{rates for }\DIFaddendFL light block \DIFdelbeginFL \DIFdelFL{. Each row is a unit’s average activity across time to the light }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(left) and sound }\DIFaddendFL block \DIFdelbeginFL \DIFdelFL{. Dashed line indicates cue onset. Notice the yellow band across time}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(right)}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{indicating all aspects of visualized task space were captured by the peak firing rates of various units}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{aligned to cue-onset}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{A, middle}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Middle}\DIFaddendFL : \DIFdelbeginFL \DIFdelFL{Same units ordered according to the time }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Distribution }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{the peak firing rate during the }\DIFdelendFL sound block \DIFdelbeginFL \DIFdelFL{. Note that for both blocks, units tile time approximately uniformly with a clear diagonal of elevated }\DIFdelendFL firing rates \DIFdelbeginFL \DIFdelFL{. A, right: Unit firing rates taken from the sound block, ordered according to peak firing rate taken from the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{using ordering for }\DIFaddendFL light block. \DIFdelbeginFL \DIFdelFL{Note that a weaker but still discernible diagonal persists, indicating partial similarity between firing rates in the two blocks. }\DIFdelendFL B\DIFdelbeginFL \DIFdelFL{: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in }\DIFdelendFL A \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL but \DIFdelbeginFL \DIFdelFL{with units }\DIFdelendFL ordered according to \DIFdelbeginFL \DIFdelFL{the time of their }\DIFdelendFL minimum firing rate. \DIFdelbeginFL \DIFdelFL{C: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{C-D. }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in A, except that the panels now compare two different locations on the track instead }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A-B for a comparison }\DIFaddendFL of two cue \DIFdelbeginFL \DIFdelFL{modalities. As for the different cue modalities, NAc units clearly discriminate between }\DIFdelendFL locations\DIFdelbeginFL \DIFdelFL{, but also maintain some similarity across locations, as evident from the visible diagonal in the right panel}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{Two example locations were used for display purposes; other location pairs showed a similar pattern. D: As for C, but with units ordered by their minimum firing rate. E: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{E-F }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in A, except that panels now compare }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A-B for comparison of }\DIFaddendFL rewarded and unrewarded \DIFdelbeginFL \DIFdelFL{trials}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{cues}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{F: As for A, but with units ordered by their minimum firing rate. Overall, NAc units "tiled" experience on the task, as opposed to being confined to specific task events only. Units from all sessions and animals were pooled for this analysis.}\DIFdelendFL }
\label{fig:tiling}
\end{figure}
...
\caption{Summary of influence of various task parameters of cue-modulated NAc units during nosepoke. A. GLM matrix demonstrating impact of various task parameters on NAc firing rates. A \DIFdelbeginFL \DIFdelFL{stepwise }\DIFdelendFL GLM was fit to each unit that showed evidence of cue modulation by a Wilcoxon signed-rank test. Each row represents a given task parameter, and \DIFdelbeginFL \DIFdelFL{each column is }\DIFdelendFL the \DIFaddbeginFL \DIFaddFL{x axis shows the }\DIFaddendFL influence of \DIFdelbeginFL \DIFdelFL{that }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the }\DIFaddendFL task \DIFdelbeginFL \DIFdelFL{parameter on a given }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{parameters for each }\DIFaddendFL unit\DIFdelbeginFL \DIFdelFL{. Response variable is how much of the firing rate variance an individual predictor contributed to the model}\DIFdelendFL , \DIFdelbeginFL \DIFdelFL{as measured by differences in R-squared between the final model and the model minus the predictor of interest. Ordering }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{organized }\DIFaddendFL from left to right \DIFdelbeginFL \DIFdelFL{: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{for }\DIFaddendFL MSNs that increased firing in response to the cue (green \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL left), MSNs with a decreasing response (red \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL left), FSIs with an increasing response (green \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL right), FSIs with a decreasing response (red \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL right). \DIFdelbeginFL \DIFdelFL{Darker shades indicate more }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Response variable is how much of the }\DIFaddendFL firing rate variance \DIFdelbeginFL \DIFdelFL{explained }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{an individual predictor contributed to the model, as measured }\DIFaddendFL by \DIFdelbeginFL \DIFdelFL{a given }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{differences in R-squared between the final model and the model minus the }\DIFaddendFL predictor \DIFaddbeginFL \DIFaddFL{of interest}\DIFaddendFL . B. \DIFdelbeginFL \DIFdelFL{Violin plots }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Bar graph }\DIFaddendFL demonstrating \DIFdelbeginFL \DIFdelFL{changes }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{average change }\DIFaddendFL in R-squared \DIFdelbeginFL \DIFdelFL{values }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{value }\DIFaddendFL with the addition of each of the individual predictors.\DIFdelbeginFL \DIFdelFL{The mean, median, and distribution of changes in R-squared values is plotted for each of the three task parameters that were significant predictors in the GLM.}\DIFdelendFL }
\label{fig:NP_GLM}
\end{figure}
\begin{figure}[h]
\centering
...
\caption{Distribution of NAc firing rates across task space during approach trials. \DIFdelbeginFL \DIFdelFL{Each panel shows normalized firing }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A. Firing }\DIFaddendFL rates for all recorded \DIFdelbeginFL \DIFdelFL{NAc }\DIFdelendFL units \DIFdelbeginFL \DIFdelFL{(each row corresponds to one unit) as a function of time (time 0 indicates nosepoke), averaged across all approach trials for a specific cue type, indicated by text labels. A, left: Heat plot showing smoothed }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{were }\DIFaddendFL normalized \DIFdelbeginFL \DIFdelFL{firing activity of all recorded NAc units }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and }\DIFaddendFL ordered according \DIFaddbeginFL \DIFaddFL{according }\DIFaddendFL to \DIFdelbeginFL \DIFdelFL{the time of their }\DIFdelendFL peak firing \DIFdelbeginFL \DIFdelFL{rate during the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{rates for }\DIFaddendFL light block \DIFdelbeginFL \DIFdelFL{. Each row is a unit’s average activity across time to the light }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(left) and sound }\DIFaddendFL block \DIFdelbeginFL \DIFdelFL{. Dashed line indicates }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(right), aligned to }\DIFaddendFL nosepoke with reward delivery occurring 1 s after nosepoke\DIFdelbeginFL \DIFdelFL{for rewarded trials}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{Notice the yellow band across time, indicating all aspects of visualized task space were captured by the peak firing rates of various units. A, middle}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Middle}\DIFaddendFL : \DIFdelbeginFL \DIFdelFL{Same units ordered according to the time }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Distribution }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{the peak firing rate during the }\DIFdelendFL sound block \DIFdelbeginFL \DIFdelFL{. Note that for both blocks, units tile time approximately uniformly with a clear diagonal of elevated }\DIFdelendFL firing rates \DIFdelbeginFL \DIFdelFL{, and a clustering around reward receipt. A, right: Unit firing rates taken from the sound block, ordered according to peak firing rate taken from the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{using ordering for }\DIFaddendFL light block. \DIFdelbeginFL \DIFdelFL{Note that a weaker but still discernible diagonal persists, indicating partial similarity between firing rates in the two blocks. }\DIFdelendFL B\DIFdelbeginFL \DIFdelFL{: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in }\DIFdelendFL A \DIFdelbeginFL \DIFdelFL{, }\DIFdelendFL but \DIFdelbeginFL \DIFdelFL{with units }\DIFdelendFL ordered according to \DIFdelbeginFL \DIFdelFL{the time of their }\DIFdelendFL minimum firing rate. \DIFdelbeginFL \DIFdelFL{C: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{C-D. }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in A, except that the panels now compare two different locations on the track instead }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A-B for a comparison }\DIFaddendFL of two cue \DIFdelbeginFL \DIFdelFL{modalities. As for the different cue modalities, NAc units clearly discriminate between }\DIFdelendFL locations\DIFdelbeginFL \DIFdelFL{, but also maintain some similarity across locations, as evident from the visible diagonal in the right panel}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{Two example locations were used for display purposes; other location pairs showed a similar pattern. D: As for C, but with units ordered by their minimum firing rate. E: }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{E-F }\DIFaddendFL Same \DIFdelbeginFL \DIFdelFL{layout }\DIFdelendFL as \DIFdelbeginFL \DIFdelFL{in A, except that panels now compare }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A-B for comparison of }\DIFaddendFL rewarded and unrewarded \DIFdelbeginFL \DIFdelFL{trials. Notice the absence of a cluster of tiling around reward receipt for unrewarded trials. F: As for A, but with units ordered by their minimum firing rate. Overall, NAc units "tiled" experience on the task, as opposed to being confined to specific task events only. Units from all sessions and animals were pooled for this analysis}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{cues}\DIFaddendFL .}
\label{fig:NP_tiling}
