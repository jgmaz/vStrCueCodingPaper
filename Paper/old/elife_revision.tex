...
%DIF ADD vStrCueCoding_elife_revisions.tex   Fri Aug 17 14:22:03 2018
...
\addtocounter{figure}{-1}
\begin{figure} [t!]
  \caption{(Previous page.) {\color{red} with pink indicating separate populations (z-score $<$ -1.96), grey indicating overlapping but independent populations, and green indicating joint overlapping populations (z-score $>$ 1.96).}}
\end{figure}
...
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth]{Fig 7 - Population averages.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth]{Fig 10 - NP GLM.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <  \begin{figure}[ht!]
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth]{Fig 11 - NP population averages.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <  \begin{figure}[ht!]
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=\textwidth]{Fig 12 - NP task tiling.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
