...
\section*{Methods}
%Version 1.2 - imported from Google Drive
%To do JG: add stats for pop level and tiling stats
...
\section*{Results}
% Version 1.2 - Imported from Google Drive
% To do JG: add more detail to text, finalize figures after Matt's approval
