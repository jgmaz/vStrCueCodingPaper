...
\end{figure} \clearpage
 ...
 \begin{figure}[ht!]
\centering
\includegraphics[height=0.4\textheight]{Fig 5 - SUPP cue onset overlap matrix.pdf}
\caption*{\bsf{Figure supplement 2:} Cue-onset overlap matrix.}
\label{fig:Q1SUPP2}
\end{figure} \clearpage
...
\end{figure} \clearpage
 ...
 \begin{figure}[ht!]
\centering
\includegraphics[height=0.6\textheight]{Fig 8 - SUPP task epoch matrices ALT.pdf}
\caption*{\bsf{Figure supplement 2:} Task epoch matrices.}
\label{fig:Q2SUPP2}
\end{figure} \clearpage

 \begin{figure}[ht!]
\centering
\includegraphics[height=0.9\textheight]{Fig 8 - SUPP cue feature matrices ALT.pdf}
\caption*{\bsf{Figure supplement 3:} Cue feature matrices.}
\label{fig:Q2SUPP3}
\end{figure} \clearpage
