...
.001; Figure \ref{fig:behav}C). Additional analyses separated each block into two halves to assess possible within session learning. Adding block half into the model did improve prediction of behavioral performance (p $=$ .86), arguing against within session learning. Thus, rats successfully
