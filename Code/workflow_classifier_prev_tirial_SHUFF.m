...
%                                 end
                                ...
                                reward_history = cat(1,metadata.TrialInfo_block1.rewarded,metadata.TrialInfo_block2.rewarded);
...
%                                 end
                                for iShuff = 1:num_Shuffs
                                    PrevTrial_shuff = datasample(reward_history,length(reward_history),'Replace',false);
                                    arm1_rew_count = 1;
                                    arm2_rew_count = 16;
                                    arm3_rew_count = 31;
                                    arm4_rew_count = 46;
                                        ...
                                        switch metadata.TrialInfo_block1.rewarded(jj)
                                            case 0
                                                switch metadata.TrialInfo_block1.photosensorID(jj)
                                                    case 1
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm1_unrew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm1_unrew_count = arm1_unrew_count + 1;
                                                    case 2
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm2_unrew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm2_unrew_count = arm2_unrew_count + 1;
                                                    case 3
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm3_unrew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm3_unrew_count = arm3_unrew_count + 1;
                                                    case 4
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm4_unrew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm4_unrew_count = arm4_unrew_count + 1;
                                                end
                                            case 1
                                                switch metadata.TrialInfo_block1.photosensorID(jj)
                                                    case 1
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm1_rew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm1_rew_count = arm1_rew_count + 1;
                                                    case 2
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm2_rew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm2_rew_count = arm2_rew_count + 1;
                                                    case 3
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm3_rew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm3_rew_count = arm3_rew_count + 1;
                                                    case 4
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm4_rew_count+starting_b1,cell_count) = PrevTrial_shuff(trials_count);
                                        ...
                                        switch metadata.TrialInfo_block2.rewarded(jj)
                                            case 0
                                                switch metadata.TrialInfo_block2.photosensorID(jj)
                                                    case 1
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm1_unrew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm1_unrew_count = arm1_unrew_count + 1;
                                                    case 2
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm2_unrew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm2_unrew_count = arm2_unrew_count + 1;
                                                    case 3
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm3_unrew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm3_unrew_count = arm3_unrew_count + 1;
                                                    case 4
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm4_unrew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm4_unrew_count = arm4_unrew_count + 1;
                                                end
                                            case 1
                                                switch metadata.TrialInfo_block2.photosensorID(jj)
                                                    case 1
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm1_rew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm1_rew_count = arm1_rew_count + 1;
                                                    case 2
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm2_rew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm2_rew_count = arm2_rew_count + 1;
                                                    case 3
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm3_rew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm3_rew_count = arm3_rew_count + 1;
                                                    case 4
                                                        LDA_raw_input{t_count}.(cat(2,'s',num2str(iShuff)))(arm4_rew_count+starting_b2,cell_count) = PrevTrial_shuff(trials_count);
                                                        arm4_rew_count = arm4_rew_count + 1;
                                                end
                                        end
...
%                                 end
                                ...
                                b2_length = length(FRATE.Cue.Trial_firing_rate_block2);
                                total = b1_length + b2_length;
                                reward_history = cat(1,metadata.TrialInfo{1,1}.rewarded,metadata.TrialInfo{1,2}.rewarded);
...
for iMdl = 1:3
prev_trial_fig_SHUFF(:,iMdl) = Class_accuracy_SHUFF.(mdl_identifier{iMdl})(:,1);
prev_trial_fig(:,iMdl) = Class_accuracy.(mdl_identifier{iMdl})(:,6);
end

%%
for iMdl = 1:length(mdl_identifier);
    Table.(mdl_identifier{iMdl}).Data = mean(Class_accuracy.(mdl_identifier{iMdl})(:,6));
    Table.(mdl_identifier{iMdl}).ShuffMEAN = mean(Class_accuracy_SHUFF.(mdl_identifier{iMdl}));
    Table.(mdl_identifier{iMdl}).ShuffSTD = std(Class_accuracy_SHUFF.(mdl_identifier{iMdl}));
    for iTime = 1%:length(Table.(mdl_identifier{iMdl}).Data)
         Table.(mdl_identifier{iMdl}).Zscore(iTime) = (Table.(mdl_identifier{iMdl}).Data(iTime) - Table.(mdl_identifier{iMdl}).ShuffMEAN(iTime)) / Table.(mdl_identifier{iMdl}).ShuffSTD(iTime);
