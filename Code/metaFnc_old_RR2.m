...
trackPB_1 = find(meta.data_block1.channels{10}> threshold); %find possible events
...
trackPB_2 = find(meta.data_block1.channels{11}> threshold); %find possible events
...
trackPB_3 = find(meta.data_block1.channels{12}> threshold); %find possible events
...
trackPB_4 = find(meta.data_block1.channels{9}> threshold); %find possible events
...
threshold = 3000; %threshold for an event
refractory_period = 5; %period of time before passing threshold considered a new event
track2PB_1 = find(meta.data_block2.channels{10}> threshold); %find possible events
...
track2PB_2 = find(meta.data_block2.channels{11}> threshold); %find possible events
...
track2PB_3 = find(meta.data_block2.channels{12}> threshold); %find possible events
...
track2PB_4 = find(meta.data_block2.channels{9}> threshold); %find possible events
