        ...
        if TESTS.WSR.Task.Trial_b4_vs_Trial < .01
            ...
            switch new_v_old
                case 0
                    ...
                    for jj = round(b1_length/2):b1_length
...
%                         end
                    ...
                    b2_start = round(b1_length/2) + 1;
                    b2_length = length(FRATE.Cue.Trial_firing_rate_block2);
                    total = round(b1_length/2) + round(b2_length/2);
                    
                    for jj = round(b2_length/2):b2_length
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-08-27-GLM_cueon_',num2str(iTime),'-2nd_half.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
