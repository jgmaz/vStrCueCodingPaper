function GLM = genGLM(directory,destination)
% function GLM = genGLM(directory,destination)
%
%
% INPUTS:
...
for iTime = -.5:.1:.5
    ...
    save(cat(2,destination,'GLM_cueon_DATA_',num2str(iTime),'.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
    clearvars -except iTime directory destination
end
