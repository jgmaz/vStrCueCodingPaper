Epoch = {'cueon' 'NP' 'NP2' 'NP3'}; %1 = cue on, 2 = NP, 3 = NP, 4 = cue off
...
file_order = {'2018-03-23-GLM_NP_-0.5.mat' '2018-03-23-GLM_NP_-0.4.mat' '2018-03-23-GLM_NP_-0.3.mat' ...
    '2018-03-23-GLM_NP_-0.2.mat' '2018-03-23-GLM_NP_-0.1.mat' '2018-03-23-GLM_NP_0.mat' '2018-03-23-GLM_NP_0.1.mat' ...
    '2018-03-23-GLM_NP_0.2.mat' '2018-03-23-GLM_NP_0.3.mat' '2018-03-23-GLM_NP_0.4.mat' '2018-03-23-GLM_NP_0.5.mat'};
    case 3
...
file_order = {'2018-03-12-GLM_NP_-0.5.mat' '2018-03-12-GLM_NP_-0.4.mat' '2018-03-12-GLM_NP_-0.3.mat' ...
    '2018-03-12-GLM_NP_-0.2.mat' '2018-03-12-GLM_NP_-0.1.mat' '2018-03-12-GLM_NP_0.mat' '2018-03-12-GLM_NP_0.1.mat' ...
    '2018-03-12-GLM_NP_0.2.mat' '2018-03-12-GLM_NP_0.3.mat' '2018-03-12-GLM_NP_0.4.mat' '2018-03-12-GLM_NP_0.5.mat'};
end
...
legend({'identity' 'location' 'NP'}); title('Cue features'); ylabel('Proportion of cue-modulated units')
...
legend({'identity' 'location' 'NP'}); title('Cue-onset'); ylabel('Proportion of cue-modulated units')
ylim([.1 .5]); xlabel('Time relative to cue-onset');
subplot(2,4,2)
plot(-.25:.1:.75,GLM_window.NP.prop(2:4,:))
hold on
plot(.2,0.1:.01:.5,'.k'); plot(-.2,0.1:.01:.5,'.k');
legend({'identity' 'location' 'NP'}); title('NP');
ylim([.1 .5]); xlabel('Time relative to NP');
% xlim([-.3 .3]);
subplot(2,4,3)
plot(-.25:.1:.75,GLM_window.NP2.prop(2:4,:))
hold on
plot(.2,0.1:.01:.5,'.k'); plot(-.2,0.1:.01:.5,'.k');
legend({'identity' 'location' 'NP'}); title('Outcome');
ylim([.1 .5]); xlabel('Time relative to NP');
% xlim([-.3 .3]);
subplot(2,4,4)
plot(-.25:.1:.75,GLM_window.NP3.prop(2:4,:))
hold on
plot(.2,0.1:.01:.5,'.k'); plot(-.2,0.1:.01:.5,'.k');
legend({'identity' 'location' 'NP'}); title('Cue-offset');
...
% xlim([-.3 .3]);
subplot(2,4,7)
shadedErrorBar(-.25:.1:.75,GLM_window.NP2.Rsquared.MEAN(1,:),GLM_window.NP2.Rsquared.SEM(1,:),'-b',1);
hold on;
shadedErrorBar(-.25:.1:.75,GLM_window.NP2.Rsquared.MEAN(2,:),GLM_window.NP2.Rsquared.SEM(2,:),'-r',1);
shadedErrorBar(-.25:.1:.75,GLM_window.NP2.Rsquared.MEAN(3,:),GLM_window.NP2.Rsquared.SEM(3,:),'-y',1);
plot(.2,2:.1:10,'.k'); plot(-.2,2:.1:10,'.k');
ylim([2 10]); xlabel('Time relative to NP');
% xlim([-.3 .3]);
subplot(2,4,8)
shadedErrorBar(-.25:.1:.75,GLM_window.NP3.Rsquared.MEAN(1,:),GLM_window.NP3.Rsquared.SEM(1,:),'-b',1);
hold on;
shadedErrorBar(-.25:.1:.75,GLM_window.NP3.Rsquared.MEAN(2,:),GLM_window.NP3.Rsquared.SEM(2,:),'-r',1);
shadedErrorBar(-.25:.1:.75,GLM_window.NP3.Rsquared.MEAN(3,:),GLM_window.NP3.Rsquared.SEM(3,:),'-y',1);
plot(.2,2:.1:10,'.k'); plot(-.2,2:.1:10,'.k');
