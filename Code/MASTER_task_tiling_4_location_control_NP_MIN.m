...
for kk = 1:length(dir('*.mat'))
    ...
    [minimum_receptacle1_1st(count),min_location_receptacle1_1st(count)] = min(PETHs.trials_receptacle1_1st_half{count}(cfg.start:cfg.end));
    [minimum_receptacle1_2nd(count),min_location_receptacle1_2nd(count)] = min(PETHs.trials_receptacle1_2nd_half{count}(cfg.start:cfg.end));
...
[MINsortPETH.receptacle1_1st.sorted,MINsortPETH.receptacle1_1st.index_sort] = sort(min_location_receptacle1_1st);
[MINsortPETH.receptacle1_2nd.sorted,MINsortPETH.receptacle1_2nd.index_sort] = sort(min_location_receptacle1_2nd);

for jj = 1:length(mat_files_drift)
    MINsortedPETH.receptacle1_1st.unaltered(jj,:) = PETHs.trials_receptacle1_1st_half{MINsortPETH.receptacle1_1st.index_sort(jj)}(cfg.start:cfg.end);
    MINsortedPETH.receptacle1_2nd.receptacle1_1st(jj,:) = PETHs.trials_receptacle1_2nd_half{MINsortPETH.receptacle1_1st.index_sort(jj)}(cfg.start:cfg.end);
    MINsortedPETH.receptacle1_2nd.unaltered(jj,:) = PETHs.trials_receptacle1_2nd_half{MINsortPETH.receptacle1_2nd.index_sort(jj)}(cfg.start:cfg.end);
    disp(jj)
end

for jj = 1:length(mat_files_drift)
    mean_peth.receptacle1_1st(jj,1) = mean(MINsortedPETH.receptacle1_1st.unaltered(jj,:));
    std_peth.receptacle1_1st(jj,1) = std(MINsortedPETH.receptacle1_1st.unaltered(jj,:));
    MINsortedPETH.receptacle1_1st.zscore(jj,:) = (MINsortedPETH.receptacle1_1st.unaltered(jj,:) - mean_peth.receptacle1_1st(jj)) / std_peth.receptacle1_1st(jj);
    mean_peth.receptacle1_2nd(jj,1) = mean(MINsortedPETH.receptacle1_2nd.unaltered(jj,:));
    std_peth.receptacle1_2nd(jj,1) = std(MINsortedPETH.receptacle1_2nd.unaltered(jj,:));
    MINsortedPETH.receptacle1_2nd.zscore(jj,:) = (MINsortedPETH.receptacle1_2nd.unaltered(jj,:) - mean_peth.receptacle1_2nd(jj)) / std_peth.receptacle1_2nd(jj);
    mean_peth.receptacle1_2nd_2_1st(jj,1) = mean(MINsortedPETH.receptacle1_2nd.receptacle1_1st(jj,:));
    std_peth.receptacle1_2nd_2_1st(jj,1) = std(MINsortedPETH.receptacle1_2nd.receptacle1_1st(jj,:));
    MINsortedPETH.receptacle1_2nd_2_1st.zscore(jj,:) = (MINsortedPETH.receptacle1_2nd.receptacle1_1st(jj,:) - mean_peth.receptacle1_2nd_2_1st(jj)) / std_peth.receptacle1_2nd_2_1st(jj);
end
...
figure;
subtightplot(3,4,1)
imagesc(-1:.001:3,1:length(mat_files_drift),MINsortedPETH.receptacle1_1st.zscore);
colorbar; caxis([-3 4]);
subtightplot(3,4,5)
imagesc(-1:.001:3,1:length(mat_files_drift),MINsortedPETH.receptacle1_2nd_2_1st.zscore);
colorbar; caxis([-3 4]);
subtightplot(3,4,9)
imagesc(-1:.001:3,1:length(mat_files_drift),MINsortedPETH.receptacle1_2nd.zscore);
colorbar; caxis([-3 4]);