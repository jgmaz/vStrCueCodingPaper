function GLMshuff = genGLMshuff(directory,destination,num_Shuffs)
% function GLMshuff = genGLMshuff(directory,destination,num_Shuffs)
%
%
% INPUTS:
...
%     save(cat(2,destination,'GLM_cueon_SHUFF_',num2str(iTime),'-intermediate_file.mat'),'mdl')
%     clearvars -except iTime destination directory num_Shuffs
% end
%%
% for iTime = -.5:.1:.5
%     load(cat(2,destination,'GLM_cueon_SHUFF_',num2str(iTime),'-intermediate_file.mat'))
...
%     mat_files = dir('*.mat');
    ...
    save(cat(2,destination,'GLM_cueon_SHUFF_',num2str(iTime),'.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
    clearvars -except iTime destination directory num_Shuffs
end
