...
%                                                         dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo_block1.approached(jj); %behav - app
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo_block1.summary(jj,15); %behav - trial length
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),6) = jj;
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),7) = firing_rate_np(trials_count); %FR
...
%                                                         dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo_block2.approached(jj);
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo_block2.summary(jj,15);
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),6) = b1_length+jj;
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),7) = firing_rate_np(trials_count);
...
%                                                          dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo{1,1}.approached(jj); %behav - app
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo{1,1}.summary(jj,15); %behav - trial length
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),6) = jj;
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),7) = firing_rate_np(trials_count); %FR
...
%                                                          dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo{1,2}.approached(jj);
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),5) = metadata.TrialInfo{1,2}.summary(jj,15);
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),6) = b1_length+jj;
                            dataset(trials_count.(cat(2,'shuff_',num2str(iShuff))),7) = firing_rate_np(trials_count);
...
for iShuff = 1:100
                ...
                %             mdl{kk}.(cat(2,'shuff_',num2str(iShuff)))= stepwiseglm(ds,'constant','upper','linear','Distribution','poisson');
               try
                mdl{kk}.(cat(2,'shuff_',num2str(iShuff))).(cat(2,'shuff_',num2str(iShuff))) = stepwiseglm(ds,'constant','upper','interactions','Distribution','poisson','PEnter',.01);
  catch %err
%     switch err.identifier
%         case 'stats:glmfit:IterationLimit'
      mdl{kk}.(cat(2,'shuff_',num2str(iShuff))).(cat(2,'shuff_',num2str(iShuff))) = [];
%       continue
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-03-16-GLM_',Epoch,'_',num2str(iTime),'-SHUFF.mat'),'mdl')
...
for iEpoch = 2
for iTime = -.5:.1:.5
        load(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-03-16-GLM_',Epoch{iEpoch},'_',num2str(iTime),'-SHUFF.mat'))
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-03-17-GLM_',Epoch{iEpoch},'_',num2str(iTime),'-SHUFF.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
clearvars -except iTime Epoch iEpoch
end
end
...
summary_table{6,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Latency;
summary_table{7,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Trial;
summary_table{8,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Previous;
summary_table{9,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxLoc;
summary_table{10,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxOut;
summary_table{11,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.LocxOut;
summary_table{12,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxLocxOut;
...
summary_table{6,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.Latency;
summary_table{7,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.Trial;
summary_table{8,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.Previous;
summary_table{9,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.ModxLoc;
summary_table{10,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.ModxOut;
summary_table{11,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.LocxOut;
summary_table{12,3} = summary_var.(cat(2,'shuff_',num2str(iShuff))).SPN.ModxLocxOut;
...
summary_table{6,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.Latency;
summary_table{7,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.Trial;
summary_table{8,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.Previous;
summary_table{9,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.ModxLoc;
summary_table{10,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.ModxOut;
summary_table{11,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.LocxOut;
summary_table{12,4} = summary_var.(cat(2,'shuff_',num2str(iShuff))).HFN.ModxLocxOut;
...
summary_table{6,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.Latency;
summary_table{7,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.Trial;
summary_table{8,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.Previous;
summary_table{9,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.ModxLoc;
summary_table{10,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.ModxOut;
summary_table{11,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.LocxOut;
summary_table{12,5} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Inc.ModxLocxOut;
...
summary_table{6,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.Latency;
summary_table{7,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.Trial;
summary_table{8,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.Previous;
summary_table{9,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.ModxLoc;
summary_table{10,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.ModxOut;
summary_table{11,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.LocxOut;
summary_table{12,6} = summary_var.(cat(2,'shuff_',num2str(iShuff))).Dec.ModxLocxOut;

save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-03-12-GLM_',Epoch,'_',num2str(iTime),'-200bin25step.mat'),'mdl','ALL_matrix.(cat(2,'shuff_',num2str(iShuff)))','block_drift','GLM_matrices','summary_var.(cat(2,'shuff_',num2str(iShuff)))')
clearvars -except iEpoch iTime
    end
end
...
consistency_check{6,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Latency;
consistency_check{7,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Trial;
consistency_check{8,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.Previous;
consistency_check{9,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxLoc;
consistency_check{10,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxOut;
consistency_check{11,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.LocxOut;
consistency_check{12,2} = summary_var.(cat(2,'shuff_',num2str(iShuff))).All.ModxLocxOut;
...
figure
heatmap(GLM_matrices.(cat(2,'shuff_',num2str(iShuff))).dev_percent.cat_combined, 'RowLabels', {'Cue modality','Cue location','Cue outcome'},... 
...
%% violin plot
figure;
violin(GLM_matrices.(cat(2,'shuff_',num2str(iShuff))).Rsquared.MEAN.ALL_NaN);
...
heatmap(GLM_matrices.(cat(2,'shuff_',num2str(iShuff))).Rsquared.cat_combined,  'RowLabels', {'Cue identity','Cue location','Cue outcome'},... 
