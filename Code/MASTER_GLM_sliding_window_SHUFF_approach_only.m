        ...
        if TESTS.WSR.Task.Trial_b4_vs_Trial < .01
            ...
            switch new_v_old
                case 0
                    ...
                    for jj = 1:b1_length
                        if metadata.TrialInfo_block1.approached(jj) == 1
...
%                                                         dataset(trials_count,5) = metadata.TrialInfo_block1.approached(jj); %behav - app
                            ...
                            dataset(trials_count,7) = firing_rate(trials_count); %FR
...
%                         end
                    ...
                    for jj = 1:b2_length
                        if metadata.TrialInfo_block2.approached(jj) == 1
...
%                                                         dataset(trials_count,5) = metadata.TrialInfo_block2.approached(jj);
                            ...
                            dataset(trials_count,7) = firing_rate(trials_count);
...
%                         end
                ...
                case 1
                    ...
                    b1_length = length(FRATE.Cue.Trial_firing_rate_block1);
                    for jj = 1:b1_length
                        if metadata.TrialInfo{1,1}.approached(jj) == 1
...
%                         end
                    ...
                    for jj = 1:b2_length
                        if metadata.TrialInfo{1,2}.approached(jj) == 1
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-05-22-GLM_cueon_APP_only_',num2str(iTime),'-SHUFF.mat'),'mdl')
clearvars -except iTime
    end
%%
    for iTime = -.5:.1:.5
        load(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-05-22-GLM_cueon_APP_only_',num2str(iTime),'-SHUFF.mat'))
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-05-23-GLM_cueon_APP_only_',num2str(iTime),'-SHUFF.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
clearvars -except iTime
    end
