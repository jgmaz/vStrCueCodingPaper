...
[sortPETH.arm1_1st.sorted,sortPETH.arm1_1st.index_sort] = sort(min_location_arm1_1st);
[sortPETH.arm1_2nd.sorted,sortPETH.arm1_2nd.index_sort] = sort(min_location_arm1_2nd);

for jj = 1:length(mat_files_drift)
    sortedPETH.arm1_1st.unaltered(jj,:) = PETHs.trials_arm1_1st_half{sortPETH.arm1_1st.index_sort(jj)}(cfg.start:cfg.end);
    sortedPETH.arm1_2nd.arm1_1st(jj,:) = PETHs.trials_arm1_2nd_half{sortPETH.arm1_1st.index_sort(jj)}(cfg.start:cfg.end);
    sortedPETH.arm1_2nd.unaltered(jj,:) = PETHs.trials_arm1_2nd_half{sortPETH.arm1_2nd.index_sort(jj)}(cfg.start:cfg.end);
    disp(jj)
end

for jj = 1:length(mat_files_drift)
    mean_peth.arm1_1st(jj,1) = mean(sortedPETH.arm1_1st.unaltered(jj,:));
    std_peth.arm1_1st(jj,1) = std(sortedPETH.arm1_1st.unaltered(jj,:));
    sortedPETH.arm1_1st.zscore(jj,:) = (sortedPETH.arm1_1st.unaltered(jj,:) - mean_peth.arm1_1st(jj)) / std_peth.arm1_1st(jj);
    mean_peth.arm1_2nd(jj,1) = mean(sortedPETH.arm1_2nd.unaltered(jj,:));
    std_peth.arm1_2nd(jj,1) = std(sortedPETH.arm1_2nd.unaltered(jj,:));
    sortedPETH.arm1_2nd.zscore(jj,:) = (sortedPETH.arm1_2nd.unaltered(jj,:) - mean_peth.arm1_2nd(jj)) / std_peth.arm1_2nd(jj);
    mean_peth.arm1_2nd_2_1st(jj,1) = mean(sortedPETH.arm1_2nd.arm1_1st(jj,:));
    std_peth.arm1_2nd_2_1st(jj,1) = std(sortedPETH.arm1_2nd.arm1_1st(jj,:));
    sortedPETH.arm1_2nd_2_1st.zscore(jj,:) = (sortedPETH.arm1_2nd.arm1_1st(jj,:) - mean_peth.arm1_2nd_2_1st(jj)) / std_peth.arm1_2nd_2_1st(jj);
end
...
figure;
subtightplot(3,4,1)
imagesc(-1:.001:3,1:length(mat_files_drift),sortedPETH.arm1_1st.zscore);
colorbar; caxis([-3 4]);
subtightplot(3,4,5)
imagesc(-1:.001:3,1:length(mat_files_drift),sortedPETH.arm1_2nd_2_1st.zscore);
colorbar; caxis([-3 4]);
subtightplot(3,4,9)
imagesc(-1:.001:3,1:length(mat_files_drift),sortedPETH.arm1_2nd.zscore);
colorbar; caxis([-3 4]);