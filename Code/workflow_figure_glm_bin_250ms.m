...
file_order = {'2018-03-12-GLM_cueon_-0.5-250ms.mat' '2018-03-12-GLM_cueon_-0.45-250ms.mat' '2018-03-12-GLM_cueon_-0.4-250ms.mat' '2018-03-12-GLM_cueon_-0.35-250ms.mat' ...
    '2018-03-12-GLM_cueon_-0.3-250ms.mat' '2018-03-12-GLM_cueon_-0.25-250ms.mat' '2018-03-12-GLM_cueon_-0.2-250ms.mat' '2018-03-12-GLM_cueon_-0.15-250ms.mat' ...
    '2018-03-12-GLM_cueon_-0.1-250ms.mat' '2018-03-12-GLM_cueon_-0.05-250ms.mat' '2018-03-12-GLM_cueon_0-250ms.mat' '2018-03-12-GLM_cueon_0.05-250ms.mat' ...
    '2018-03-12-GLM_cueon_0.1-250ms.mat' '2018-03-12-GLM_cueon_0.15-250ms.mat' '2018-03-12-GLM_cueon_0.2-250ms.mat' '2018-03-12-GLM_cueon_0.25-250ms.mat' ...
    '2018-03-12-GLM_cueon_0.3-250ms.mat' '2018-03-12-GLM_cueon_0.35-250ms.mat' '2018-03-12-GLM_cueon_0.4-250ms.mat' '2018-03-12-GLM_cueon_0.45-250ms.mat' '2018-03-12-GLM_cueon_0.5-250ms.mat'};
    case 2
mat_files = dir('2018-03-12-GLM_NP*');
predictor_list = {'Cue' 'Modality' 'Location' 'Outcome'};
file_order = {'2018-03-12-GLM_NP_-0.5.mat' '2018-03-12-GLM_NP_-0.4.mat' '2018-03-12-GLM_NP_-0.3.mat' ...
    '2018-03-12-GLM_NP_-0.2.mat' '2018-03-12-GLM_NP_-0.1.mat' '2018-03-12-GLM_NP_0.mat' '2018-03-12-NP_0.1.mat' ...
    '2018-03-12-GLM_NP_0.2.mat' '2018-03-12-GLM_NP_0.3.mat' '2018-03-12-GLM_NP_0.4.mat' '2018-03-12-NP_0.5.mat'};
    case 3
mat_files = dir('2018-03-12-GLM_outcome*');
predictor_list = {'Cue' 'Modality' 'Location' 'Outcome'};
file_order = {'2018-03-12-GLM_outcome_-0.5.mat' '2018-03-12-GLM_outcome_-0.4.mat' '2018-03-12-GLM_outcome_-0.3.mat' ...
    '2018-03-12-GLM_outcome_-0.2.mat' '2018-03-12-GLM_outcome_-0.1.mat' '2018-03-12-GLM_outcome_0.mat' '2018-03-12-GLM_outcome_0.1.mat' ...
    '2018-03-12-GLM_outcome_0.2.mat' '2018-03-12-GLM_outcome_0.3.mat' '2018-03-12-GLM_outcome_0.4.mat' '2018-03-12-GLM_outcome_0.5.mat'};
    case 4
...
figure;
subplot(2,3,1)
plot(-.25:.05:.75,GLM_window.cueon.prop(2:4,:))
hold on
...
subplot(2,3,2)
plot(-.25:.05:.75,GLM_window.cueon.prop(5:6,:))
hold on
plot(.2,0.01:.01:.5,'.k'); plot(-.2,0.01:.01:.5,'.k');
ylim([0 .5]); title('Behavioral measures'); xlabel('Time relative to cue-onset');
legend({'approach' 'latency'});
subplot(2,3,3)
plot(-.25:.05:.75,GLM_window.cueon.prop(7:8,:))
hold on
plot(.2,0.01:.01:.5,'.k'); plot(-.2,0.01:.01:.5,'.k');
ylim([0 .5]); title('Task history'); xlabel('Time relative to cue-onset');
legend({'trial number' 'previous trial'});
subplot(2,3,4)
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(1,:),GLM_window.cueon.Rsquared.SEM(1,:),'-b',1);
hold on
plot(.2,1:.1:8,'.k'); plot(-.2,1:.1:8,'.k');
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(2,:),GLM_window.cueon.Rsquared.SEM(2,:),'-r',1);
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(3,:),GLM_window.cueon.Rsquared.SEM(3,:),'-y',1);
ylim([1 8]); ylabel('Mean variance explained'); xlabel('Time relative to cue-onset');
subplot(2,3,5)
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(4,:),GLM_window.cueon.Rsquared.SEM(4,:),'-b',1);
hold on
plot(.2,1:.1:8,'.k'); plot(-.2,1:.1:8,'.k');
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(5,:),GLM_window.cueon.Rsquared.SEM(5,:),'-r',1);
ylim([1 8]); xlabel('Time relative to cue-onset');
subplot(2,3,6)
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(6,:),GLM_window.cueon.Rsquared.SEM(6,:),'-b',1);
hold on
plot(.2,1:.1:8,'.k'); plot(-.2,1:.1:8,'.k');
shadedErrorBar(-.25:.05:.75,GLM_window.cueon.Rsquared.MEAN(7,:),GLM_window.cueon.Rsquared.SEM(7,:),'-r',1);
ylim([1 8]); xlabel('Time relative to cue-onset');
