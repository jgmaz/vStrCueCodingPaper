...
dataset(trials_count,1) = metadata.TrialInfo_block1.approached(jj-1);
...
dataset(trials_count,1) = metadata.TrialInfo_block2.approached(jj-1);
...
%                         if metadata.TrialInfo{1,1}.summary(jj,2) == metadata.TrialInfo{1,1}.summary(jj,3)
                            if jj == 1
                                ...
                                dataset(trials_count,2) = NaN; %prev trial
                                 ...
                                 dataset(trials_count,1) = metadata.TrialInfo{1,1}.approached(jj-1);
...
dataset(trials_count,1) = metadata.TrialInfo{1,2}.approached(jj-1);
...
%                         end
            ...
            if sum(dataset(:,9)) < 10
                ...
                %%
                ds = mat2dataset(dataset,'VarNames',{'PrevApp','Previous','Outcome','Modality','Location','Approach','Latency','Trial','FiringRate'});
...
summary_var.All.PrevApp = 0;
summary_var.HFN.PrevApp = 0;
summary_var.SPN.PrevApp = 0;
summary_var.Inc.PrevApp = 0;
summary_var.Dec.PrevApp = 0;
summary_var.HFN_Inc.PrevApp = 0;
summary_var.HFN_Dec.PrevApp = 0;
summary_var.SPN_Inc.PrevApp = 0;
summary_var.SPN_Dec.PrevApp = 0;
                                                            ...
                                                            switch strcmp(mdl{1,kk}.CoefficientNames(ll),'Latency');
                                                                ...
                                                                case 0
                                                                    ...
                                                                    GLM_matrices.Rsquared.ALL(kk,7) = (mdl{kk}.Rsquared.Adjusted - GLM_matrices.Comparison.Previous{kk}.Rsquared.Adjusted) * 100;
                                                                                ...
                                                                                case 0
                                                                                    switch strcmp(mdl{1,kk}.CoefficientNames(ll),'PrevApp');
                                                                                case 1
                                                                                    summary_var.All.PrevApp = summary_var.All.PrevApp + 1;
                                                                                    GLM_matrices.count.combined(count,13) = 1;
                                                                                    ALL_matrix(kk,13) = 1;
                                                                                    GLM_matrices.Comparison.PrevApp{kk} = removeTerms(mdl{kk},'PrevApp');
                                                                    GLM_matrices.Rsquared.ALL(kk,13) = (mdl{kk}.Rsquared.Adjusted - GLM_matrices.Comparison.PrevApp{kk}.Rsquared.Adjusted) * 100;
                                                                                    idx = strcmp(mdl{1,kk}.Steps.History.TermName,'PrevApp');
                                                                                    dev_location = find(idx == 1);
                                                                                    dev_raw = mdl{1,kk}.Steps.History.Deviance(dev_location-1) - mdl{1,kk}.Steps.History.Deviance(dev_location);
                                                                                    dev_percent = (dev_raw / mdl{1,kk}.Steps.History.Deviance(dev_location-1)) * 100;
                                                                                    GLM_matrices.dev_raw.combined(count,13) = dev_raw;
                                                                                    GLM_matrices.dev_percent.combined(count,13) = dev_percent;
                                                                                    switch class.all.sorted_isi{kk}(5) < 2
                                                                                        case 1
                                                                                            summary_var.HFN.PrevApp = summary_var.HFN.PrevApp + 1;
                                                                                            switch mean(FRATE.Task.Trial_firing_rate) > mean(FRATE.Task.Trial_B4_firing_rate)
                                                                                                case 1
                                                                                                    summary_var.HFN_Inc.PrevApp = summary_var.HFN_Inc.PrevApp + 1;
                                                                                                    summary_var.Inc.PrevApp = summary_var.Inc.PrevApp + 1;
                                                                                                    GLM_matrices.count.HFN_Inc(count_HFN_Inc,13) = 1;
                                                                                                    GLM_matrices.dev_raw.HFN_Inc(count_HFN_Inc,13) = dev_raw;
                                                                                                    GLM_matrices.dev_percent.HFN_Inc(count_HFN_Inc,13) = dev_percent;
                                                                                                    GLM_matrices.Rsquared.HFN_Inc(count_HFN_Inc,13) = GLM_matrices.Rsquared.ALL(kk,13);
                                                                                                case 0
                                                                                                    summary_var.HFN_Dec.PrevApp = summary_var.HFN_Dec.PrevApp + 1;
                                                                                                    summary_var.Dec.PrevApp = summary_var.Dec.PrevApp + 1;
                                                                                                    GLM_matrices.count.HFN_Dec(count_HFN_Dec,13) = 1;
                                                                                                    GLM_matrices.dev_raw.HFN_Dec(count_HFN_Dec,13) = dev_raw;
                                                                                                    GLM_matrices.dev_percent.HFN_Dec(count_HFN_Dec,13) = dev_percent;
                                                                                                    GLM_matrices.Rsquared.HFN_Dec(count_HFN_Dec,13) = GLM_matrices.Rsquared.ALL(kk,13);
                                                                                            end
                                                                                        case 0
                                                                                            summary_var.SPN.PrevApp = summary_var.SPN.PrevApp + 1;
                                                                                            switch mean(FRATE.Task.Trial_firing_rate) > mean(FRATE.Task.Trial_B4_firing_rate)
                                                                                                case 1
                                                                                                    summary_var.SPN_Inc.PrevApp = summary_var.SPN_Inc.PrevApp + 1;
                                                                                                    summary_var.Inc.PrevApp = summary_var.Inc.PrevApp + 1;
                                                                                                    GLM_matrices.count.SPN_Inc(count_SPN_Inc,13) = 1;
                                                                                                    GLM_matrices.dev_raw.SPN_Inc(count_SPN_Inc,13) = dev_raw;
                                                                                                    GLM_matrices.dev_percent.SPN_Inc(count_SPN_Inc,13) = dev_percent;
                                                                                                    GLM_matrices.Rsquared.SPN_Inc(count_SPN_Inc,13) = GLM_matrices.Rsquared.ALL(kk,13);
                                                                                                case 0
                                                                                                    summary_var.SPN_Dec.PrevApp = summary_var.SPN_Dec.PrevApp + 1;
                                                                                                    summary_var.Dec.PrevApp = summary_var.Dec.PrevApp + 1;
                                                                                                    GLM_matrices.count.SPN_Dec(count_SPN_Dec,13) = 1;
                                                                                                    GLM_matrices.dev_raw.SPN_Dec(count_SPN_Dec,13) = dev_raw;
                                                                                                    GLM_matrices.dev_percent.SPN_Dec(count_SPN_Dec,13) = dev_percent;
                                                                                                    GLM_matrices.Rsquared.SPN_Dec(count_SPN_Dec,13) = GLM_matrices.Rsquared.ALL(kk,13);
                                                                                            end
                                                                                    end
                                                                                case 0
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-06-09-GLM_cueon_',num2str(iTime),'-recodePrevBeh_Cue','.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
