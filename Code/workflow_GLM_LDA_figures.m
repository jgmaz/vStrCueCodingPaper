...
shadedErrorBar(-.5:.1:.5,GLM_window_SHUFF.NP.prop.MEAN.Outcome,GLM_window_SHUFF.NP.prop.ZSTD.Outcome,'--g',1);
...
plot(-.5:.1:.5,GLM_window.NP.prop(4,:),'-og','MarkerFaceColor','g','MarkerSize',4)
...
shadedErrorBar(-.5:.1:.5,GLM_window_SHUFF.outcome.prop.MEAN.Outcome,GLM_window_SHUFF.outcome.prop.ZSTD.Outcome,'--g',1);
...
plot(-.5:.1:.5,GLM_window.outcome.prop(4,:),'-og','MarkerFaceColor','g','MarkerSize',4)
...
shadedErrorBar(-.5:.1:.5,GLM_window.NP.Rsquared.MEAN(3,:),GLM_window.NP.Rsquared.SEM(3,:),'-g',1);
...
shadedErrorBar(-.5:.1:.5,GLM_window_SHUFF.NP.Rsquared.MEAN.Outcome,GLM_window_SHUFF.NP.Rsquared.SEM.Outcome,'--g',1);
...
shadedErrorBar(-.5:.1:.5,GLM_window.outcome.Rsquared.MEAN(3,:),GLM_window.outcome.Rsquared.SEM(3,:),'-g',1);
...
shadedErrorBar(-.5:.1:.5,GLM_window_SHUFF.outcome.Rsquared.MEAN.Outcome,GLM_window_SHUFF.outcome.Rsquared.SEM.Outcome,'--g',1);
