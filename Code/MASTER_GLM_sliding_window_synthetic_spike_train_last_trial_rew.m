...
%%
%     for iTime = -.4:.1:.5
%         load(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-05-27-GLM_cueon_',num2str(iTime),'-SYNTH_full_trial.mat'),'mdl');
mat_files = dir('*.mat');
...
save(cat(2,'E:\Jimmie\Jimmie\Analysis\2018-06-04-GLM_cueon_',num2str(iTime),'-SYNTH_np_and_trial_recode.mat'),'mdl','ALL_matrix','block_drift','GLM_matrices','summary_var')
