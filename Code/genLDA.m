function Class_accuracy_DATA = genLDA(directory,destination,num_Iterations)
% function Class_accuracy_DATA = genLDA(directory,destination,num_Iterations)
%
%
% INPUTS:
...
%% Convert MCR to CR
for iMdl = 1:length(mdl_identifier)
    Class_accuracy_DATA.(mdl_identifier{iMdl}) = 1 - LDA_Error.(mdl_identifier{iMdl});
end

save(cat(2,destination,'LDA_DATA_performance.mat'),'Class_accuracy_DATA')
