...
%                         if metadata.TrialInfo_block1.summary(jj,2) == metadata.TrialInfo_block1.summary(jj,3) % if correct response
 if metadata.TrialInfo_block1.nosepokeT(jj) ~= 0
        ...
        these_spk = spk_t(spk_t > dataPoint.Nosepokes(trials_count)/1000 & spk_t < end_time(trials_count));
...
%                         if TESTS.WSR.Task.Trial_b4_vs_Trial < .01
                            ...
                            switch class.all.sorted_isi{kk}(5) < 2
                                case 1
                                    ...
                                    switch mean(FRATE.Task.Nosepoke_firing_rate) > mean(FRATE.Task.Trial_np_firing_rate)
                                        case 1
