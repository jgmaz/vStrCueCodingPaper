...
Step = [.100 .050 .050 .025];
Analysis = {'.mat' '-500bin50step.mat' '-250ms.mat' '-200bin25step.mat'};
var_name = {'b500s10' 'b500s50' 'b250s50' 'b200s25'};
    case 2
mat_files = dir('2018-03-12-GLM_NP*');
predictor_list = {'Cue' 'Modality' 'Location' 'Outcome'};
Step = [.100 .050 .025];
Analysis = {'-500bin.mat' '.mat' '-200bin25step.mat'};
var_name = {'b500s100' 'b250s50' 'b200s25'};
    case 3
...
GLM_window.(Epoch{iEpoch}).(var_name{iStep}).prop = GLM_window.(Epoch{iEpoch}).(var_name{iStep}).window / 133;
